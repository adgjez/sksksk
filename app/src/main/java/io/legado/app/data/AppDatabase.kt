...
@Database(
    ...
    entities = [Book::class, BookGroup::class, BookSource::class, BookChapter::class,
        ...
        // AI features added in 100 -> 109 port
        AiAgentJob::class, AiAgentSession::class, AiAgentTrace::class,
        AiGeneratedImage::class, AiImageGroup::class,
        ...
        // Companion features required by AI code (also ported from source)
        BookCharacter::class, BookCharacterRelation::class,
        ReadAloudBgmGroup::class, ReadAloudBgmTrack::class,
        ReadAloudBgmAssignmentCache::class,
...
abstract class AppDatabase : RoomDatabase() {
    ...
    // Companion features (also ported)
